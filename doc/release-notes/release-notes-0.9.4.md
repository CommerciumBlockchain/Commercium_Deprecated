Commercium Core version 0.9.4 is now available from:

  https://commercium.org/bin/0.9.4/
...
this update is incompatible with the Commercium system and could lead to consensus
forks.

Commercium Core released binaries from https://commercium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~commercium/+archive/ubuntu/commercium
- A third-party or self-compiled Commercium Core

upgrade to Commercium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
