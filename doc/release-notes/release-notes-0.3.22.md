Download URL: https://sourceforge.net/projects/commercium/files/Commercium/commercium-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CMM fee schedule (users still pay 0.01 CMM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #commercium00 - #commercium99
