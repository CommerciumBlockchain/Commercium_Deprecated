Commercium Core version 0.10.4 is now available from:

  <https://commercium.org/bin/commercium-core-0.10.4/>
...
- #6953 `43c2789` Split commercium-tx into its own package
- #6953 `dfe0d4d` Include commercium-tx binary on Debian/Ubuntu
