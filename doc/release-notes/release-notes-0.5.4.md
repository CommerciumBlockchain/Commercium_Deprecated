Commercium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/commercium/files/Commercium/commercium-0.5.4/
...
http://gitorious.org/commercium/commerciumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Commercium-Qt notifications under Growl 1.3.
Increase required age of Commercium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCommercium properly when installing Commercium-Qt over it. (Windows)
