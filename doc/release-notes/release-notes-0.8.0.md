Commercium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/commercium/files/Commercium/commercium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Commercium
...
New/changed settings (command-line or commercium.conf file)
--------------------------------------------------------
