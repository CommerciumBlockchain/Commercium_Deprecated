Commercium Core version 0.9.2.1 is now available from:

  https://commercium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CMM to 0.01 CMM
...
- Fix "Start commercium on system login"
