Commercium Core version 0.13.2 is now available from:

  <https://commercium.org/bin/commercium-core-0.13.2/>
...
- #8908 `4a974b2` Update commercium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow commercium-tx to create v2 transactions (btndrak)
