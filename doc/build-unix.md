UNIX BUILD NOTES
====================
Some notes on how to build Commercium in Unix.
...
Note
---------------------
Always use absolute paths to configure and compile Commercium and the dependencies,
...
This will build commercium-qt as well if the dependencies are met.
...
See the section "Disable-wallet mode" to build Commercium without wallet.
...
If you want to build Commercium-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a commercium-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip commerciumd" to strip the debug
...
# Configure Commercium to use our own-built instance of BDB
cd $COMMERCIUM_ROOT
./autogen.sh
...
Security
--------
To help make your Commercium installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Commercium should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Commercium may be compiled in
...
As mentioned above, when maintaining portability of the wallet between the standard Commercium distributions and independently built
...
with 4.8-built Commercium is needed follow the steps under "Berkeley DB" above.
