...
(2) below, as formalized by BUIP040 [1] and used by the Commercium Unlimited
...
to existing pre-fork Commercium consensus rules.
...
Once the fork has activated, transactions consisting exclusively of a single OP_RETURN output, followed by a single minimally-coded data push with the specific magic data value of
    ...
    Commercium: A Peer-to-Peer Electronic Cash System
...
implementations seeking to be compliant should consult the Commercium C++
...
### OPT-SERVICEBIT (NODE_COMMERCIUM_CASH service bit)
...
NOTE 2: This bit is currently referred to as NODE_COMMERCIUM_CASH and displayed
as "CASH" in user interfaces of some Commercium clients (BU, ABC).
...
[2] https://github.com/commercium/bips/blob/master/bip-0143.mediawiki#Motivation

[3] [Digest for replay protected signature verification accross hard forks](replay-protected-sighash.md)

[4] https://github.com/Commercium-UAHF/spec/blob/master/uahf-test-plan.md
