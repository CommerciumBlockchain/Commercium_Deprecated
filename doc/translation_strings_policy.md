...
This document provides guidelines for internationalization of the Commercium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `commercium_en.ts` remains unchanged.
