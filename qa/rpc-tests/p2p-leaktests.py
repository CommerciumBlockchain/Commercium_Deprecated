#!/usr/bin/env python3
# Copyright (c) 2017 The Commercium Core developers
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if commerciumd ban
    # behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(CommerciumTestFramework):
