#!/usr/bin/env python3
# Copyright (c) 2018 The Commercium Core developers
...
class SpentIndexTest(CommerciumTestFramework):
    ...
    def run_test(self):
        ...
        feeSatoshis = 10000
        privkey = "cNhk6xLjkXoWDaM5KGp4aptCdio9sbpGPbCcfajXRzBRoLHPrDMG"
        address = "tL3twPZgxyHEPZUAUYJrqig33Q4MNv5X1U"
        addressHash = bytes([143,250,165,74,212,216,9,40,192,121,144,30,228,45,109,194,200,20,134,31])
        ...
        privkey2 = "cNhk6xLjkXoWDaM5KGp4aptCdio9sbpGPbCcfajXRzBRoLHPrDMG"
        address2 = "tL3twPZgxyHEPZUAUYJrqig33Q4MNv5X1U"
        addressHash2 = bytes([143,250,165,74,212,216,9,40,192,121,144,30,228,45,109,194,200,20,134,31])
        ...
        assert_equal(block["deltas"][1]["inputs"][0]["address"], "tL3twPZgxyHEPZUAUYJrqig33Q4MNv5X1U")
        ...
        assert_equal(block["deltas"][1]["outputs"][0]["address"], "tL3twPZgxyHEPZUAUYJrqig33Q4MNv5X1U")
