...
# TestNode: A peer we use to send messages to commerciumd, and store responses.
...
class CompactBlocksTest(CommerciumTestFramework):
    ...
    # This test actually causes commerciumd to (reasonably!) disconnect us, so do
    # this last.
    ...
    # Test that commerciumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for commerciumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # commerciumd will not send blocktxn responses for blocks whose height is
