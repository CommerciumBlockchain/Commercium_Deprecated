...
#ifndef COMMERCIUM_INIT_H
#define COMMERCIUM_INIT_H
...
/** Initialize commercium core: Basic context setup.
...
/**
 * Commercium core main initialization.
...
enum HelpMessageMode { HMM_COMMERCIUMD, HMM_COMMERCIUM_QT };
