...
#ifndef COMMERCIUM_RPCPROTOCOL_H
#define COMMERCIUM_RPCPROTOCOL_H
...
enum RPCErrorCode {
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in commerciumd
...
#endif // COMMERCIUM_RPCPROTOCOL_H
