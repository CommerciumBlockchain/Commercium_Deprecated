...
#ifndef COMMERCIUM_ARITH_UINT256_H
#define COMMERCIUM_ARITH_UINT256_H
...
public:
     ...
     *
     * Commercium only uses this "compact" format for encoding difficulty targets,
...
#endif // COMMERCIUM_ARITH_UINT256_H
