...
#ifndef COMMERCIUM_WALLET_WALLET_H
#define COMMERCIUM_WALLET_WALLET_H
...
public:
     ...
     * on this commercium node, and set to 0 for transactions that were created
...
#endif // COMMERCIUM_WALLET_WALLET_H
