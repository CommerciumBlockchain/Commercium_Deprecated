...
#ifndef COMMERCIUM_SCRIPT_SCRIPT_H
#define COMMERCIUM_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Commercium always counted CHECKMULTISIGs as 20 sigops. With
...
#endif // COMMERCIUM_SCRIPT_SCRIPT_H
