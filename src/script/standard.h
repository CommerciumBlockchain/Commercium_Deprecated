...
#ifndef COMMERCIUM_SCRIPT_STANDARD_H
#define COMMERCIUM_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a commercium address
 */
...
#endif // COMMERCIUM_SCRIPT_STANDARD_H
