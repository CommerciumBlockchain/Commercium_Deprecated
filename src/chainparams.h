...
#ifndef COMMERCIUM_CHAINPARAMS_H
#define COMMERCIUM_CHAINPARAMS_H
 ...
 * Commercium system. There are three: the main network on which people trade goods
...
public:
    ...
    const CMessageHeader::MessageStartChars &CmmMessageStart() const {
        return pchCmmMessageStart;
    }
...
protected:
    ...
    CMessageHeader::MessageStartChars pchCmmMessageStart;
    int nDefaultPort;
...
#endif // COMMERCIUM_CHAINPARAMS_H
