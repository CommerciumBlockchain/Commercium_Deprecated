 ...
 * thread wrappers.
 */
#ifndef COMMERCIUM_UTIL_H
#define COMMERCIUM_UTIL_H
...
extern const char *const COMMERCIUM_CONF_FILENAME;
extern const char *const COMMERCIUM_PID_FILENAME;
