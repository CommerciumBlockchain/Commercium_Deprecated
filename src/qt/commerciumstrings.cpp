...
#define UNUSED
#endif
static const char UNUSED *commercium_strings[] = {
    QT_TRANSLATE_NOOP("commercium-core", "Commercium Core"),
    QT_TRANSLATE_NOOP("commercium-core", "The %s developers"),
    QT_TRANSLATE_NOOP("commercium-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("commercium-core", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("commercium-core", "%s is set very high!"),
    QT_TRANSLATE_NOOP("commercium-core", "(default: %s)"),
    QT_TRANSLATE_NOOP("commercium-core", "(default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("commercium-core", "<category> can be:"),
    QT_TRANSLATE_NOOP("commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Block creation options:"),
    QT_TRANSLATE_NOOP("commercium-core", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("commercium-core", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("commercium-core", "Cannot write default address"),
    QT_TRANSLATE_NOOP("commercium-core", "Chain selection options:"),
    QT_TRANSLATE_NOOP("commercium-core", "Change index out of range"),
    QT_TRANSLATE_NOOP("commercium-core", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("commercium-core", "Connection options:"),
    QT_TRANSLATE_NOOP("commercium-core", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("commercium-core", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("commercium-core", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("commercium-core", "Done loading"),
    QT_TRANSLATE_NOOP("commercium-core", "Enable publish hash block in <address>"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Enable publish hash transaction in <address>"),
    QT_TRANSLATE_NOOP("commercium-core", "Enable publish raw block in <address>"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Enable publish raw transaction in <address>"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Enable transaction replacement in the memory pool (default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "Error initializing block database"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("commercium-core", "Error loading %s"),
    QT_TRANSLATE_NOOP("commercium-core", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("commercium-core", "Error loading %s: You can't disable HD "
                                      "on a already existing HD wallet"),
    QT_TRANSLATE_NOOP("commercium-core", "Error loading block database"),
    QT_TRANSLATE_NOOP("commercium-core", "Error opening block database"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("commercium-core", "Error"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("commercium-core", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Importing..."),
    QT_TRANSLATE_NOOP(
        "commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Information"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("commercium-core", "Insufficient funds"),
    QT_TRANSLATE_NOOP("commercium-core", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("commercium-core", "Invalid -proxy address: '%s'"),
    QT_TRANSLATE_NOOP("commercium-core", "Invalid amount for -%s=<amount>: '%s'"),
    QT_TRANSLATE_NOOP("commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Listen for JSON-RPC connections on "
                                      "<port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Listen for connections on <port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "Loading addresses..."),
    QT_TRANSLATE_NOOP("commercium-core", "Loading banlist..."),
    QT_TRANSLATE_NOOP("commercium-core", "Loading block index..."),
    QT_TRANSLATE_NOOP("commercium-core", "Loading wallet..."),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Location of the auth cookie (default: data dir)"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Maintain at most <n> connections to peers (default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "Make the wallet broadcast transactions"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Node relay options:"),
    QT_TRANSLATE_NOOP("commercium-core", "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("commercium-core", "Options:"),
    QT_TRANSLATE_NOOP("commercium-core", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("commercium-core", "Print version and exit"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("commercium-core", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("commercium-core", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("commercium-core", "Reducing -maxconnections from %d to %d, "
                                      "because of system limitations."),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("commercium-core", "Rescanning..."),
    QT_TRANSLATE_NOOP("commercium-core", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Set key pool size to <n> (default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("commercium-core", "Specify data directory"),
    QT_TRANSLATE_NOOP("commercium-core", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("commercium-core", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("commercium-core", "Starting network threads..."),
    QT_TRANSLATE_NOOP("commercium-core", "The source code is available from %s."),
    QT_TRANSLATE_NOOP("commercium-core",
                      "The transaction amount is too small to pay the fee"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "The wallet will avoid paying less than the minimum relay fee."),
    QT_TRANSLATE_NOOP("commercium-core", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Transaction too large for fee policy"),
    QT_TRANSLATE_NOOP("commercium-core", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "commercium-core",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("commercium-core", "Unable to bind to %s on this computer. "
    ...
    QT_TRANSLATE_NOOP("commercium-core", "Use the test chain"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("commercium-core", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("commercium-core", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("commercium-core", "Verifying wallet..."),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("commercium-core", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("commercium-core",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("commercium-core", "Wallet options:"),
    QT_TRANSLATE_NOOP("commercium-core", "Warning"),
    QT_TRANSLATE_NOOP("commercium-core",
    ...
    QT_TRANSLATE_NOOP("commercium-core", "ZeroMQ notification options:"),
};
