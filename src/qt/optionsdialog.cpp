...
/* Window elements init */
    ...
    ui->commerciumAtStartup->setToolTip(
        ui->commerciumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->commerciumAtStartup->setText(
        ui->commerciumAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new CommerciumUnits(this));
...
void OptionsDialog::setMapper() {
    /* Main */
    mapper->addMapping(ui->commerciumAtStartup, OptionsModel::StartAtStartup);
