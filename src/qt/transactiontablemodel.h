...
#ifndef COMMERCIUM_QT_TRANSACTIONTABLEMODEL_H
#define COMMERCIUM_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx,
                           ...
                           CommerciumUnits::SeparatorStyle separators =
                               CommerciumUnits::separatorStandard) const;
...
#endif // COMMERCIUM_QT_TRANSACTIONTABLEMODEL_H
