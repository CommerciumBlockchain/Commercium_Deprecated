...
#ifndef COMMERCIUM_QT_SENDCOINSENTRY_H
#define COMMERCIUM_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending commerciums.
...
#endif // COMMERCIUM_QT_SENDCOINSENTRY_H
