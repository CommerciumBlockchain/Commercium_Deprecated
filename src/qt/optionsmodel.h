...
#ifndef COMMERCIUM_QT_OPTIONSMODEL_H
#define COMMERCIUM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Commercium client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,          // QString
        ProxyPortTor,        // int
        DisplayUnit,         // CommerciumUnits::Unit
...
#endif // COMMERCIUM_QT_OPTIONSMODEL_H
