...
#ifndef COMMERCIUM_QT_COMMERCIUMUNITS_H
#define COMMERCIUM_QT_COMMERCIUMUNITS_H
...
/**
 * Commercium unit definitions. Encapsulates parsing and formatting and serves as
 * list model for drop-down selection boxes.
 */
class CommerciumUnits : public QAbstractListModel {
    Q_OBJECT

public:
    explicit CommerciumUnits(QObject *parent);

    /**
     * Commercium units (Commercium Cash unit work the same as Bitoin).
...
typedef CommerciumUnits::Unit CommerciumUnit;

#endif // COMMERCIUM_QT_COMMERCIUMUNITS_H
