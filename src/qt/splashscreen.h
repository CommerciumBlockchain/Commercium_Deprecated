...
#ifndef COMMERCIUM_QT_SPLASHSCREEN_H
#define COMMERCIUM_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Commercium Core initialization
...
#endif // COMMERCIUM_QT_SPLASHSCREEN_H
