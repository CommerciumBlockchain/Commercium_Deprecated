...
public:
    ...
    inline void paint(QPainter *painter, const QStyleOptionViewItem &option,
        ...
        painter->setPen(foreground);
        QString amountText = CommerciumUnits::formatWithUnit(
            unit, amount, true, CommerciumUnits::separatorAlways);
        if (!confirmed) {
...
void OverviewPage::setBalance(const CAmount &balance,
    ...
    ui->labelBalance->setText(CommerciumUnits::formatWithUnit(
        unit, balance, false, CommerciumUnits::separatorAlways));
    ui->labelUnconfirmed->setText(CommerciumUnits::formatWithUnit(
        unit, unconfirmedBalance, false, CommerciumUnits::separatorAlways));
    ui->labelImmature->setText(CommerciumUnits::formatWithUnit(
        unit, immatureBalance, false, CommerciumUnits::separatorAlways));
    ui->labelTotal->setText(CommerciumUnits::formatWithUnit(
        unit, balance + unconfirmedBalance + immatureBalance, false,
        CommerciumUnits::separatorAlways));
    ui->labelWatchAvailable->setText(CommerciumUnits::formatWithUnit(
        unit, watchOnlyBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchPending->setText(CommerciumUnits::formatWithUnit(
        unit, watchUnconfBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchImmature->setText(CommerciumUnits::formatWithUnit(
        unit, watchImmatureBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchTotal->setText(CommerciumUnits::formatWithUnit(
        unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance,
        false, CommerciumUnits::separatorAlways));
