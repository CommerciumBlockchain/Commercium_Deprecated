...
#ifndef COMMERCIUM_QT_COMMERCIUMGUI_H
#define COMMERCIUM_QT_COMMERCIUMGUI_H
...
/**
 * Commercium GUI main class. This class represents the main window of the Commercium
 * UI. It communicates with both the client and wallet models to give the user
 * an up-to-date view of the current core state.
 */
class CommerciumGUI : public QMainWindow {
    Q_OBJECT
...
public:
    ...
    explicit CommerciumGUI(const PlatformStyle *platformStyle,
     ...
     * The wallet model represents a commercium wallet, and offers access to the
...
#endif // COMMERCIUM_QT_COMMERCIUMGUI_H
