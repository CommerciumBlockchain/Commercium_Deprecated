...
QString TransactionDesc::toHTML(CWallet *wallet, CWalletTx &wtx,
    ...
    if (wtx.IsCoinBase() && nCredit == 0) {
        ...
        if (wtx.IsInMainChain())
            strHTML += CommerciumUnits::formatHtmlWithUnit(unit, nUnmatured) +
        ...
        //
        strHTML += "<b>" + tr("Credit") + ":</b> " +
                   CommerciumUnits::formatHtmlWithUnit(unit, nNet) + "<br>";
    } else {
        ...
        if (fAllFromMe) {
            ...
            for (const CTxOut &txout : wtx.tx->vout) {
                ...
                strHTML += "<b>" + tr("Debit") + ":</b> " +
                           CommerciumUnits::formatHtmlWithUnit(
            ...
            if (fAllToMe) {
                ...
                strHTML += "<b>" + tr("Total debit") + ":</b> " +
                           CommerciumUnits::formatHtmlWithUnit(unit, -nValue) +
                           "<br>";
    ...
    strHTML += "<b>" + tr("Net amount") + ":</b> " +
               CommerciumUnits::formatHtmlWithUnit(unit, nNet, true) + "<br>";
    ...
    // Message from normal commerciumcash:URI (commerciumcash:123...?message=example)
