...
#ifndef COMMERCIUM_QT_COMMERCIUMAMOUNTFIELD_H
#define COMMERCIUM_QT_COMMERCIUMAMOUNTFIELD_H
...
/** Widget for entering commercium amounts.
  */
class CommerciumAmountField : public QWidget {
    Q_OBJECT

    // ugly hack: for some unknown reason CAmount (instead of qint64) does not
    // work here as expected
    // discussion: https://github.com/commercium/commercium/pull/5117
    Q_PROPERTY(
        qint64 value READ value WRITE setValue NOTIFY valueChanged USER true)

public:
    explicit CommerciumAmountField(QWidget *parent = 0);
...
#endif // COMMERCIUM_QT_COMMERCIUMAMOUNTFIELD_H
