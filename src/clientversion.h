...
#ifndef COMMERCIUM_CLIENTVERSION_H
#define COMMERCIUM_CLIENTVERSION_H
...
//! These need to be macros, as clientversion.cpp's and commercium*-res.rc's voodoo
//! requires it
...
/**
 * commerciumd-res.rc includes this file, but it cannot cope with real c++ code.
...
#endif // COMMERCIUM_CLIENTVERSION_H
