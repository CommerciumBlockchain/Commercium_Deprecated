// Copyright (c) 2012-2015 The Commercium Core developers
...
void dumpKeyInfo(uint256 privkey) {
    ...
    for (int nCompressed = 0; nCompressed < 2; nCompressed++) {
        ...
        printf("    * address (base58): %s\n",
               CCommerciumAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
BOOST_AUTO_TEST_CASE(key_test1) {
    CCommerciumSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
