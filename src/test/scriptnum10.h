...
#ifndef COMMERCIUM_TEST_SCRIPTNUM10_H
#define COMMERCIUM_TEST_SCRIPTNUM10_H
...
class CScriptNum10 {
    /**
     * The ScriptNum implementation from Commercium Core 0.10.0, for
     * cross-comparison.
     */
public:
...
#endif // COMMERCIUM_TEST_BIGNUM_H
