// Copyright (c) 2014 The Commercium Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef COMMERCIUM_CRYPTO_COMMON_H
#define COMMERCIUM_CRYPTO_COMMON_H

#if defined(HAVE_CONFIG_H)
#include "commercium-config.h"
#endif
...
#endif // COMMERCIUM_CRYPTO_COMMON_H
