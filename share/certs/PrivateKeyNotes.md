...
unlocked to sign the Commercium-Qt.app bundle.
...
allowing somebody to distribute a Commercium-Qt.app or commercium-qt-setup.exe with a valid
...
that the commercium-qt.exe file inside the installer had not been tampered with.
